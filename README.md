...
```
Название=HEXКод,Название2=HEXКод2,...
```
...
✅ собрать красивую таблицу всех свойств
✅ добавить схемы работы авто-режима
✅ собрать версию README на английском
